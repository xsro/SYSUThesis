...
\input{figure/chap03/tbm_layer}
\input{figure/chap03/confusion}
\section{多张图片的插入}
...
\input{figure/chap03/temperature_density}
\input{figure/chap03/compare}

如果实在有需要直接插入多张图片的需求，则参考如图 \ref{fig:section_compare} 所示的例子。
\input{figure/chap03/section_compare}
\section{本章小结}
