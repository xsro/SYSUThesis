...
\input{figure/chap01/ustc}
\input{figure/chap01/tsinghua}
\input{figure/chap01/texlive}
...
\input{figure/chap01/texlivecmd}

第三步，安装TeXstudio并配置。一般来说安装完成之后TeXstudio能自动识别已安装的TeX Live，打开TeXstudio，在上方找到Options $\rightarrow$ Configure TeXstudio并点击（图 \ref{fig:texstudio1}），在Build中将Default Compiler选为XeLaTeX，Default Bibliography Tool（默认参考文献工具）选为BibTeX（图 \ref{fig:texstudio2}）。
\input{figure/chap01/texstudio1}
\input{figure/chap01/texstudio2}
...
综上，上述四个步骤的操作能让你在Windows 10/11+TeX Live+TeXstudio的环境下得到与github页面中内容一模一样的pdf文档。
